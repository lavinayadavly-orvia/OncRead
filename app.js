...
const watchlistSignals = [
  ...
  },
  {
    ...
    status: "negative",
    statusLabel: "Peer-reviewed performance; negative primary endpoint",
    ...
    effect: "The randomized primary endpoint was not met: 706 versus 688 stage III-IV cancers across 12 prespecified types, IRR 1.03 (95% CI 0.92-1.14; p=0.6324). Stage IV diagnoses were 342 versus 397, a 14% secondary reduction (IRR 0.86; 95% CI 0.744-0.998). The peer-reviewed intervention-arm analysis reported 937 MCED-detected primary cancers, aggregate PPV 52.0%, specificity 99.50%-99.60%, and episode sensitivity of 37.2%, 27.1%, and 26.7% across rounds 1-3.",
    whyMatters: "This is the largest randomized population test of blood-based multi-cancer screening. Strong specificity and cancer-signal localization do not establish clinical benefit, and the negative primary endpoint should prevent test performance from being presented as proof that routine screening improves outcomes.",
    ...
    decisionImpact: "Routine population rollout should await patient-outcome, overdiagnosis, utilization, and cost-effectiveness evidence. The secondary stage IV reduction is hypothesis-generating rather than a substitute for the failed combined stage III-IV endpoint.",
    evidenceStrength: "Very large blinded randomized clinical-utility trial plus a peer-reviewed prespecified descriptive performance analysis. The primary clinical-utility result remains available as a conference abstract rather than a full peer-reviewed report.",
    limitations: "The peer-reviewed paper reports intervention-arm performance rather than the randomized primary clinical-utility analysis and uses descriptive analyses without hypothesis testing. Mortality, overdiagnosis, healthcare utilization, psychological outcomes, and cost-effectiveness remain unresolved. GRAIL funded the study and participated in design, data curation, interpretation, and drafting, although Queen Mary University of London independently conducted the analysis.",
    ...
    nextMilestone: "Full peer-reviewed publication of the randomized clinical-utility analysis, cancer-specific mortality, overdiagnosis and resource-use results, regulatory decisions, and India validation or access milestones.",
    verification: "Nature Medicine reports the prespecified secondary performance analysis; ASCO LBA100 reports the separate randomized primary and stage-shift results. PATHFINDER 2 provides supportive single-arm performance and safety context but does not establish clinical utility.",
    source: "https://www.nature.com/articles/s41591-026-04652-8",
    secondarySource: "https://ascopubs.org/doi/10.1200/JCO.2026.44.17_suppl.LBA100"
  },
  {
...
const portfolioAliasRules = [
  ...
  { match: /nhs-galleri|galleri|mced|nct05611632|pathfinder 2|nct05155605/i, aliases: ["NHS-Galleri", "Galleri", "MCED", "NCT05611632", "PATHFINDER 2", "NCT05155605"] },
