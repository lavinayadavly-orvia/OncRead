...
const watchlistSignals = [
  {
    ...
    short: "ADVANCE chemotherapy-free strategy",
    category: "Radiotherapy / targeted therapy strategy",
    status: "conference",
    statusLabel: "Peer-reviewed early-stopped Phase III",
    geography: "China; randomized trial at 11 enrolling sites with supportive multicenter real-world cohort",
    date: "21 September 2026",
    cancer: "Unresectable stage III non-squamous NSCLC with centrally confirmed EGFR exon 19 deletion or L858R mutation",
    issue: "The peer-reviewed ADVANCE trial tested nine weeks of induction aumolertinib followed by concurrent aumolertinib plus definitive radiotherapy and aumolertinib consolidation as a chemotherapy-free alternative to platinum-based concurrent chemoradiotherapy.",
    organization: "Cancer Hospital, Chinese Academy of Medical Sciences-led investigators; Jiangsu Hansoh Pharmaceutical Group supplied aumolertinib and chemotherapy agents",
    population: "43 of a planned 98 patients were randomized: 24 to aumolertinib plus radiotherapy and 19 to concurrent chemoradiotherapy. Eligible adults were 18-75 years old, ECOG 0-1, treatment-naive, and had unresectable stage IIIA-C non-squamous NSCLC with EGFR exon 19 deletion or L858R mutation.",
    comparator: "Aumolertinib 110 mg once daily for nine weeks, then concurrent aumolertinib plus 60 Gy radiotherapy and consolidation aumolertinib, versus two cycles of platinum-based concurrent chemoradiotherapy with optional consolidation chemotherapy or surveillance. The control did not include post-chemoradiotherapy osimertinib, which became a relevant standard after LAURA.",
    endpoint: "Primary endpoint was progression-free survival in the intention-to-treat population; secondary outcomes included overall survival, objective response, radiotherapy volumes, safety, and quality of life.",
    effect: "At median follow-up of 25.5 months, median PFS was 34.0 months (95% CI 16.0-52.1) versus 7.4 months (95% CI 4.8-10.0), HR 0.15 (95% CI 0.06-0.38; p<0.001). Median OS was not reached versus 30.5 months, HR 0.32 with p=0.09. ORR was 70.8% versus 63.2% (p=0.75). The trial stopped early after 25 PFS events and randomized only 43 patients.",
    whyMatters: "A chemotherapy-free targeted-radiotherapy strategy could reduce hematologic and gastrointestinal burden while preserving curative-intent local treatment for a molecularly defined stage III population. The result is hypothesis-strengthening rather than practice-defining because its precision and external validity are limited.",
    whoAffected: "Patients with unresectable EGFR-mutated stage III NSCLC, thoracic oncologists, radiation oncologists, molecular-testing programs, multidisciplinary tumor boards, regulators, payers, and developers of EGFR-directed chemoradiation alternatives.",
    decisionImpact: "Supports larger confirmatory trials and careful trial consideration. It should not replace current chemoradiotherapy followed by guideline-concordant EGFR-targeted consolidation because the study was severely under-enrolled, stopped early outside a prespecified efficacy boundary, and used a control that became outdated during enrollment.",
    evidenceStrength: "Moderate as an emerging randomized signal: peer-reviewed, prospectively registered Phase III evidence with blinded radiologic review and complete follow-up, but only 43 patients were randomized, the open-label trial stopped early, and the supportive real-world cohort was nonrandomized.",
    limitations: "China-only population; planned sample 98 but randomized sample 43; open-label design; premature closure prompted by observed PFS separation, slow accrual, and loss of equipoise; efficacy stopping was not prespecified; possible overestimation from early stopping; immature OS; 60% crossover to aumolertinib after control-arm progression; nonrandomized real-world validation; and a control arm without the later LAURA osimertinib-consolidation standard.",
    indiaImpact: "CDSCO's oncology SEC reviewed Glenmark's April 2026 proposal to manufacture and market aumolertinib 55 mg with a Phase III waiver. The committee did not support the waiver at that stage and requested Southeast Asian subset data and a structured Phase IV protocol. No CDSCO authorization for aumolertinib or this radiotherapy regimen, official India price, reimbursement, procurement, access program, or launch date was verified.",
    cost: "No official regimen cost, aumolertinib price in India, comparative radiotherapy cost, reimbursement decision, procurement figure, or cost-effectiveness result was reported or verified.",
    nextMilestone: "Adequately powered randomized comparison against a contemporary control including post-chemoradiotherapy EGFR-targeted consolidation, mature OS and late pulmonary toxicity, broader geographic validation, guideline review, and any completed CDSCO evaluation or official India access milestone.",
    verification: "Verified from the 21 September 2026 peer-reviewed ADVANCE publication, prospective ChiCTR registration ChiCTR2000040590, the earlier ASCO 2025 abstract, and CDSCO's 7 April 2026 oncology SEC recommendation. The randomized and observational cohorts remain explicitly separated.",
    source: "https://www.nature.com/articles/s41392-026-02891-2",
    secondarySource: "https://www.chictr.org.cn/showprojEN.html?proj=65006"
  },
  {
  ...
  {
    id: "gfh375-kras-g12d-phase1-phase2",
    title: "GFH375 oral KRAS G12D inhibitor",
    short: "GFH375 / VS-7375",
    category: "Peer-reviewed early-phase targeted therapy",
    status: "conference",
    statusLabel: "Phase I publication; Phase II conference update",
    geography: "China; multicenter Phase I/II program",
    date: "15 September 2026",
    cancer: "Previously treated KRAS G12D-mutant advanced solid tumors, including pancreatic ductal adenocarcinoma and NSCLC",
    issue: "Nature Medicine published first-in-human Phase I data for the oral KRAS G12D ON/OFF inhibitor GFH375, while GenFleet separately reported an expanded Phase II NSCLC cohort at IASLC WCLC 2026.",
    organization: "GenFleet Therapeutics; Shanghai Chest Hospital and participating China centers; Verastem Oncology holds development and commercialization rights outside China",
    population: "The peer-reviewed Phase I analysis included 74 heavily treated patients: 43 with pancreatic ductal adenocarcinoma, 16 with NSCLC, 10 with colorectal cancer, and five with other solid tumors. The separate WCLC Phase II update described 75 previously treated NSCLC patients at 600 mg once daily, with 71 evaluable for response.",
    comparator: "Single-arm treatment without a concurrent control. Outcomes cannot establish superiority over chemotherapy, another KRAS inhibitor, or standard molecularly guided care.",
    endpoint: "Phase I primary endpoints were safety, tolerability, maximum tolerated dose, and recommended Phase II dose; secondary endpoints included pharmacokinetics, response, duration, PFS, and OS. The WCLC expansion reported response, disease control, PFS, OS landmarks, and safety.",
    effect: "In the Phase I publication, confirmed ORR was 35.1% (13/37) in evaluable PDAC and 35.7% (5/14) in evaluable NSCLC; median PFS was 5.5 months in both groups, median OS was 9.9 months in PDAC and 13.4 months in NSCLC, and median response duration in PDAC was 5.6 months. In the separate sponsor-reported NSCLC expansion, confirmed ORR was 52.1%, disease control 93%, median PFS 8.3 months overall, and 12-month OS 77%; median OS was not reached.",
    whyMatters: "KRAS G12D is common in pancreatic, lung, and colorectal cancers and has lacked an approved mutation-specific oral inhibitor. Peer-reviewed human activity across two major tumor types and a larger NSCLC expansion support continued registrational development, while the evidence remains early and noncomparative.",
    whoAffected: "Patients with KRAS G12D-mutant advanced cancers, molecular-testing programs, thoracic and gastrointestinal oncologists, early-phase trial sites, regulators, payers, and developers of RAS-directed therapies.",
    decisionImpact: "Supports molecular screening and clinical-trial consideration where available. It should not change routine treatment, establish a preferred sequencing strategy, or be represented as an approval until randomized and registrational evidence is available.",
    evidenceStrength: "Moderate as an emerging signal: the Phase I dataset is peer reviewed with protocol and statistical materials, and the trial registry confirms the program. The larger NSCLC expansion is conference and sponsor reported, single arm, and not yet peer reviewed in the captured sources.",
    limitations: "China-only, open-label, nonrandomized cohorts; small tumor-specific Phase I denominators; no control arm; response estimates are vulnerable to selection and follow-up effects; confidence intervals were not reported in the captured abstract; the Phase I and WCLC cohorts are distinct and should not be pooled; randomized survival benefit and patient-reported outcomes are unknown.",
    indiaImpact: "No India trial site, CDSCO authorization, official India price, reimbursement, procurement, named-patient access program, or India launch date for GFH375 or VS-7375 was reported or verified. KRAS G12D testing availability and cost would also affect future access.",
    cost: "Investigational therapy; no official commercial price, India price, molecular-testing price, reimbursement decision, procurement figure, or cost-effectiveness result was reported or verified.",
    nextMilestone: "Peer-reviewed Phase II NSCLC results, mature duration and survival follow-up, randomized Kylin-Flight 01 and registration-directed TARGET-D 202 results, broader geographic validation, regulatory submissions and decisions, and any official India trial or access milestone.",
    verification: "Verified from the 15 September 2026 Nature Medicine publication, ClinicalTrials.gov NCT06500676, and GenFleet's WCLC Phase II release. One treatment-related grade 5 septic-shock event and Grade 3 or higher treatment-related adverse events in 36.5% were reported in Phase I; the WCLC update reported greater Grade 3 or higher hepatotoxicity when checkpoint-inhibitor exposure occurred within 90 days (16.7% versus 0%).",
    source: "https://www.nature.com/articles/s41591-026-04559-4",
    secondarySource: "https://clinicaltrials.gov/study/NCT06500676"
  },
  {
  ...
  {
    id: "galleri",
    title: "NHS-Galleri randomized MCED screening",
    short: "Galleri-NHS",
    category: "Screening / diagnostics",
    status: "negative",
    statusLabel: "FDA panel favorable; primary endpoint negative",
    geography: "United Kingdom",
    date: "23 September 2026",
    cancer: "Multiple cancers",
    issue: "Three annual Galleri multi-cancer early-detection blood tests added to usual-care screening",
    organization: "NHS England + GRAIL + FDA Molecular and Clinical Genetics Devices Panel",
    population: "142,250 asymptomatic adults aged 50-78 randomized after baseline blood collection; 71,122 to intervention and 71,128 to control",
    comparator: "Standard screening alone vs standard screening plus annual MCED testing",
    endpoint: "Randomized reduction in stage III-IV diagnoses, plus prespecified descriptive test-performance endpoints across three annual rounds",
    effect: "The peer-reviewed randomized primary endpoint was not met: 706 versus 688 stage III-IV cancers across 12 prespecified types, IRR 1.03 (95% CI 0.92-1.14; p=0.63). Stage IV diagnoses were lower in a key secondary analysis, IRR 0.86 (95% CI 0.74-1.00). Less than 1% of participants had trial-related adverse events and none were serious. On 23 September, an FDA advisory panel voted 10-0 that Galleri is safe, 6-4 that it is effective, and 7-2 with one abstention that benefits outweigh risks; the vote is nonbinding and Galleri is not FDA approved. The separate peer-reviewed intervention-arm analysis reported 937 MCED-detected primary cancers, aggregate PPV 52.0%, specificity 99.50%-99.60%, and declining episode sensitivity across rounds.",
    whyMatters: "This is the largest randomized population test of blood-based multi-cancer screening and now a live US regulatory decision. The favorable panel recommendation does not erase the negative primary clinical-utility endpoint, and strong test performance still does not establish improved patient outcomes.",
    ...
    decisionImpact: "FDA must make the final PMA decision and define any label or postapproval requirements; the advisory vote is not an approval. Routine population rollout should still await patient-outcome, mortality, overdiagnosis, utilization, and cost-effectiveness evidence. The secondary stage IV result is not a substitute for the failed combined stage III-IV endpoint.",
    evidenceStrength: "Very large peer-reviewed blinded randomized clinical-utility trial, a peer-reviewed prespecified descriptive performance analysis, and a formal FDA advisory-panel review. The randomized primary endpoint was negative and the panel's efficacy vote was split 6-4.",
    limitations: "The primary stage III-IV endpoint was negative and the stage IV confidence interval reached 1.00. Mortality, overdiagnosis, healthcare utilization, psychological outcomes, and cost-effectiveness remain unresolved. The advisory vote is nonbinding. GRAIL funded the trial and participated in design, data curation, interpretation, and drafting, although Queen Mary University of London independently conducted the analysis.",
    indiaImpact: "No India cohort, CDSCO authorization, ICMR program adoption, official India price, reimbursement, procurement pathway, or announced India launch was verified. The negative primary endpoint argues against routine Indian population rollout before local clinical-utility and implementation evidence exists.",
    cost: "No official India price, reimbursement, government procurement cost, or India-specific cost-effectiveness analysis was verified.",
    nextMilestone: "FDA's final PMA decision, exact labeling and any postapproval requirements; cancer-specific mortality, overdiagnosis, resource-use and cost results; and India validation or access milestones. No official FDA decision date has been announced.",
    verification: "The NEJM publication reports the randomized primary analysis; Nature Medicine reports the separate prespecified performance analysis. FDA meeting materials confirm the proposed indication and voting questions. The vote tally is from GRAIL's official release and was cross-checked against contemporaneous independent reporting.",
    source: "https://www.nejm.org/doi/full/10.1056/NEJMoa2505723",
    secondarySource: "https://investors.grail.com/news-releases/news-release-details/fda-advisory-committee-votes-favor-approval-grails-gallerir"
  },
  {
    id: "eagle-ai-esophageal-ct-screening",
    title: "EAGLE AI esophageal-cancer detection on noncontrast CT",
    short: "EAGLE CT screening",
    category: "Diagnostics / AI screening",
    status: "conference",
    statusLabel: "Peer-reviewed multicohort validation",
    geography: "China-led validation across China, the Czech Republic, and Australia",
    date: "22 September 2026",
    cancer: "Esophageal cancer and high-grade intraepithelial neoplasia",
    issue: "AI analysis of existing noncontrast chest CT and low-dose CT to identify people who may need diagnostic endoscopy",
    organization: "Sun Yat-sen University Cancer Center-led EAGLE investigators",
    population: "80,612 participants across development, external test, real-world, prospective hospital, low-dose CT, and paired CT-endoscopy cohorts",
    comparator: "EAGLE predictions compared with endoscopy and histopathology, clinical follow-up, and radiologist interpretation across cohort types; no randomized patient-outcome comparator",
    endpoint: "Cancer and precancer sensitivity, specificity, positive predictive value, false-positive reduction, reader performance, and endoscopy risk stratification",
    effect: "Across eight external test cohorts (n=11,466), cancer sensitivity was 90.0% and specificity 98.5%; precancer sensitivity was 52.5%. Calibration reduced false positives by 72.7% in a 35,402-person real-world cohort while preserving sensitivity. Prospective hospital validation (n=17,446) yielded 42.2% PPV, and a 10,959-person real-world low-dose CT cohort yielded 99.94% specificity. In paired CT-endoscopy cohorts, a higher-sensitivity operating point detected 65.0% of precancers and 78.4% of stage I cancers.",
    whyMatters: "The approach could use chest CT already obtained for other reasons to identify an otherwise difficult-to-screen cancer and triage scarce endoscopy capacity, but diagnostic accuracy alone does not prove fewer late diagnoses or deaths.",
    whoAffected: "Adults receiving chest CT or low-dose lung screening, radiology services, gastroenterology and endoscopy programs, and health systems in high-incidence regions.",
    decisionImpact: "Whether the model should move into prospective workflow trials and targeted endoscopy pathways rather than routine clinical deployment.",
    evidenceStrength: "Moderate diagnostic-validation signal from a large peer-reviewed multicenter and multicountry dataset with prospective hospital validation, but much of the evidence is retrospective and no randomized patient-outcome trial was reported.",
    limitations: "Paired CT-endoscopy analyses were retrospective and the screening simulation came from one prospective site with few positives. Follow-up was under two years in prospective and real-world low-dose CT validation, recommended endoscopy adherence was suboptimal, and the reader study lacked full crossover. Mortality, interval cancers, overdiagnosis, downstream harms, cost-effectiveness, and implementation outcomes were not established.",
    indiaImpact: "Potentially relevant where chest CT is available and endoscopy capacity is constrained, but no India cohort, local workflow validation, CDSCO or ICMR adoption, official price, reimbursement, procurement, or announced launch was verified.",
    cost: "No official software price, integration cost, India reimbursement, procurement price, or cost-effectiveness estimate was reported or verified.",
    nextMilestone: "Prospective diverse-population workflow trials with complete endoscopy follow-up, interval-cancer and harm reporting, patient-outcome and cost-effectiveness analyses, regulatory review, and India validation.",
    verification: "Peer-reviewed Nature Medicine multicohort study registered as ChiCTR2300074806. Findings are represented as diagnostic validation, not proof of screening benefit or an authorization.",
